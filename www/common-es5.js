...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /*! exports provided: SearchType, ApiService */
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function getCharacter(id) {
          return this.http.get("https://breakingbadapi.com/api/characters/".concat(id));
        }
      }, {
        key: "getQuotes",
        ...
        value: function getQuote(id) {
          return this.http.get("https://breakingbadapi.com/api/quotes/".concat(id));
        }
      }, {
        key: "getDeaths",
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY_CHARACTER = 'favouriteCharacters';
        ...
        value: function favouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this3.storage.set(STORAGE_KEY_CHARACTER, result);
            } else {
              return _this3.storage.set(STORAGE_KEY_CHARACTER, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(STORAGE_KEY_CHARACTER, result);
            }
          });
        }
      }]);
